      ...
      <table className="w-full border-collapse border border-gray-300">
        <thead >
          <tr className="bg-gray-100">
            ...
            <th className="border border-gray-300 p-2">Checked By P.O (sign & date)</th>
            <th className="border border-gray-300 p-2">Checked By Q.A.I (sign & date)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border border-gray-300 p-2">1</td>
            <td className="border border-gray-300 p-2" style={{width: '500px'}}>
              <TextField  
                style={{width: '500px'}}
                  type="text" 
            ...
            <td className="border border-gray-300 p-2">
              ...
              <TextField 
                ...
                onChange={(e) => handleVerificationChange(0, 'pboDate', e.target.value)}
                fullWidth
            ...
            <td  className="border border-gray-300 p-2">
              ...
              />
                ...
                onChange={(e) => handleVerificationChange(0, 'checkedByPODate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
               <TextField 
                ...
                onChange={(e) => handleVerificationChange(0, 'checkedByQAIDate', e.target.value)}
                fullWidth
          ...
          <td className="border border-gray-300 p-2">
            ...
            <td className="border border-gray-300 p-2">
              ...
              <TextField 
                ...
                onChange={(e) => handleVerificationChange(1, 'pboDate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              <TextField 
                ...
                onChange={(e) => handleVerificationChange(1, 'checkedByPODate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
               <TextField 
                ...
                onChange={(e) => handleVerificationChange(1, 'checkedByQAIDate', e.target.value)}
                fullWidth
          ...
          <td className="border border-gray-300 p-2">3.</td>
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
               <TextField 
                ...
                onChange={(e) => handleVerificationChange(2, 'pboDate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
               <TextField 
                ...
                onChange={(e) => handleVerificationChange(2, 'checkedByPODate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
                ...
                onChange={(e) => handleVerificationChange(2, 'checkedByQAIDate', e.target.value)}
                fullWidth
          ...
          <td className="border border-gray-300 p-2">
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
               <TextField 
                ...
                onChange={(e) => handleVerificationChange(3, 'pboDate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              <TextField 
                ...
                onChange={(e) => handleVerificationChange(3, 'checkedByPODate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
                ...
                onChange={(e) => handleVerificationChange(3, 'checkedByQAIDate', e.target.value)}
                fullWidth
          ...
          <td className="border border-gray-300 p-2">
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
                ...
                onChange={(e) => handleVerificationChange(4, 'pboDate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              <TextField 
                ...
                onChange={(e) => handleVerificationChange(4, 'checkedByPODate', e.target.value)}
                fullWidth
            ...
            <td className="border border-gray-300 p-2">
              ...
              />
               <TextField 
                ...
                onChange={(e) => handleVerificationChange(4, 'checkedByQAIDate', e.target.value)}
                fullWidth
