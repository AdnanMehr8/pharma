...
const BatchManufacturingFormPage8 = () => {
  ...
  const { requestForAnalysis } = useSelector((state) => state.mixing);
  ...
  const handleObservationChange = (index, field, value) => {
    ...
    dispatch(setMixingRecord({ requestForAnalysis: { ...requestForAnalysis, qaObservations: updatedObservations } }));
  };
          ...
          <tr>
            ...
            <td>
              <input
                ...
                onChange={(e) => dispatch(setMixingRecord({ requestForAnalysis: { ...requestForAnalysis, qaOfficer: e.target.value } }))} 
              />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input
                ...
                onChange={(e) => dispatch(setMixingRecord({ requestForAnalysis: { ...requestForAnalysis, qaManager: e.target.value } }))} 
              />
            </td>
          </tr>
        </tbody>
