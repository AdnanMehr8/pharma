...
//     dispatch(setMixingRecord({ requestForAnalysisMixing: { ...requestForAnalysisMixing, qaObservations: updatedObservations } }));
//   };
...
//         <tbody>
//           {/* QA Fields */}
//           {Object.keys(requestForAnalysisMixing.qa).map((key) => (
//             <tr key={key}>
//               <td>{key.replace(/([A-Z])/g, ' $1')}: </td>
//               <td>
//                 <input
//                   type={key.toLowerCase().includes('date') ? 'date' : key.toLowerCase().includes('time') ? 'time' : 'text'}
//                   value={requestForAnalysisMixing.qa[key]}
...
//         </thead>
//         <tbody>
//           {requestForAnalysisMixing.qaObservations.map((observation, index) => (
//             <tr key={index}>
//               <td>
//               {/* {index === 0 && 'Placement'}
...
//                 onChange={(e) => dispatch(setMixingRecord({ requestForAnalysisMixing: { ...requestForAnalysisMixing, qaOfficer: e.target.value } }))}
//               />
//             </td>
//           </tr>
//           <tr>
...
//                 onChange={(e) => dispatch(setMixingRecord({ requestForAnalysisMixing: { ...requestForAnalysisMixing, qaManager: e.target.value } }))}
//               />
//             </td>
//           </tr>
//         </tbody>
...
<tbody>
  <tr className="border p-2">
  <td><strong>Sample collected on:</strong></td>
              ...
              <tr key={index}>
                ...
                <td className="border border-gray-300 p-2 text-center"
                  ...
                  style={{width: '100px'}}
                    ...
                    onChange={() => handleObservationChange(index, 'statusMixing', 'OK')}
                  />
                </td>
                <td className="border border-gray-300 p-2 text-center"
                  ...
                  style={{width: '100px'}}
                    ...
                    onChange={() => handleObservationChange(index, 'statusMixing', 'Not OK')}
                  />
                </td>
                <td className="border border-gray-300 p-2">
                  <TextField
        ...
        <div>
          <p>
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(setMixingRecord({
                  requestForAnalysisMixing: { ...requestForAnalysisMixing, qaOfficer: e.target.value }
                }))
              }
              className="ml-2 border border-gray-300 p-1"
            />
        ...
        <div>
          <p>
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(setMixingRecord({
                  requestForAnalysisMixing: { ...requestForAnalysisMixing, qaManager: e.target.value }
                }))
              }
              className="ml-2 border border-gray-300 p-1"
            />
