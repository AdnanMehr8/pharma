            ...
            <tr>
              ...
              <td>
                <input
                  type="datetime-local"
                  name="date"
                  value={packing.batchRecord.date || ""}
              ...
              <td>
                <input
                  type="text"
                  name="lineClearance"
                  value={packing.batchRecord.lineClearance || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <input
                  type="text"
                  name="department"
                  value={packing.batchRecord.department || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
              ...
              <td>
                <input
                  type="text"
                  name="section"
                  value={packing.batchRecord.section || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <input
                  type="text"
                  name="currentProduct"
                  value={packing.batchRecord.currentProduct || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
              ...
              <td>
                <input
                  ...
                  value={packing.batchRecord.currentProductBatchNo || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  value={packing.batchRecord.previousProduct || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
              ...
              <td>
                <input
                  ...
                  value={packing.batchRecord.previousProductBatchNo || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <input
                  type="text"
                  name="signature"
                  value={packing.batchRecord.signature || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <input
                  type="text"
                  name="temperature"
                  value={packing.tempAndHumidity.temperature || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
              ...
              <td>
                <input
                  type="text"
                  name="humidity"
                  value={packing.tempAndHumidity.humidity || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  value={packing.authorization.authorizedForUse || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
              ...
              <td>
                <input
                  type="datetime-local"
                  name="dateAndTime"
                  value={packing.authorization.dateAndTime || ""}
                  onChange={handleInputChange}
                  className="border border-gray-300 p-1"
                />
              </td>
