...
const BatchManufacturingFormPage9 = () => {
  ...
  const scompressionRecord = useSelector((state) => state.scompression); // Access the scompression state
  ...
  const handleEquipmentChange = (e, index) => {
    ...
    const updatedLineClearance = scompressionRecord.lineClearance.map((item, i) => {
    ...
    dispatch(setsCompressionRecord({ ...scompressionRecord, lineClearance: updatedLineClearance }));
  };
  ...
  const handleInputChange = (e, index) => {
    ...
    const updatedPrecautions = {
      ...scompressionRecord.precautions,
      [name]: value,
    };
    ...
    dispatch(setsCompressionRecord({ ...scompressionRecord, precautions: updatedPrecautions, lineClearance: updatedLineClearance }));
  };
  ...
  const addRow = () => {
    ...
    dispatch(setsCompressionRecord({ ...scompressionRecord, lineClearance: [...scompressionRecord.lineClearance, newLineClearanceRecord] }));
  };
      ...
      <CardContent>
        <div className="mt-6">
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            <div>
              - Before scompression, carefully check the following:
              <ul>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <TextField
                label="Section"
                name="section"
                value={scompressionRecord.precautions.section || ''}
              ...
              <TextField
                label="Area"
                name="specificArea"
                value={scompressionRecord.precautions.specificArea || ''}
                style={{ marginLeft: "0.5rem" }}
                onChange={handleInputChange}
            ...
            <strong>
              <span style={{display: "flex", alignItems: 'center'}}>
                ...
                <TextField
                  ...
                  value={scompressionRecord.precautions.precautionsRead}
        ...
        <div className="mt-6">
          ...
          <TableContainer component={Paper}>
            <Table>
              ...
              <TableBody>
                {scompressionRecord.lineClearance.map((item, index) => (
                  <TableRow key={index}>
