...
const BatchManufacturingFormPage4 = () => {
  ...
  const smixingRecord = useSelector((state) => state.smixing);
  ...
  const handleEquipmentChange = (e, index) => {
    ...
    const updatedLineClearance = smixingRecord.lineClearance.map((item, i) => {
    ...
    dispatch(
      setsMixingRecord({ ...smixingRecord, lineClearance: updatedLineClearance })
    );
  };
  ...
  const addRow = () => {
    ...
    dispatch(
      setsMixingRecord({
        ...smixingRecord,
        lineClearance: [...smixingRecord.lineClearance, newLineClearanceRecord],
      })
    );
  };
          ...
          <div style={{ marginBottom: "1rem" }}>
            <span style={{ display: "flex", alignItems: "center" }}>
              ...
              <TextField
                label="SOP"
                name="sop1"
                value={smixingRecord.precautions.sop1 || ""}
            ...
            <span style={{ display: "flex", alignItems: "center" }}>
              ...
              <TextField
                label="SOP"
                name="sop2"
                value={smixingRecord.precautions.sop2 || ""}
                style={{ marginLeft: "0.5rem", margin: 0 }}
                onChange={handleInputChange}
                multiline
              />
            ...
            <span style={{ display: "flex", alignItems: "center" }}>
              ...
              <TextField
                label="Section"
                name="section"
                value={smixingRecord.precautions.section || ""}
                style={{ marginLeft: "0.5rem", margin: 0 }}
                onChange={handleInputChange}
                multiline
              />
              ...
              <TextField
                label="Area"
                name="specificArea"
                value={smixingRecord.precautions.specificArea || ""}
            ...
            <strong>
              <span style={{ display: "flex", alignItems: "center" }}>
                ...
                <TextField
                  ...
                  value={smixingRecord.precautions.precautionsRead}
        ...
        <div className="mt-6">
          ...
          <TableContainer component={Paper}>
            <Table>
              ...
              <TableBody>
                {smixingRecord.lineClearance.map((item, index) => (
                  <TableRow key={index}>
