...
export default function BatchManufacturingFormPage15() {
  ...
  const sccompressionState = useSelector((state) => state.sccompression);

  const handleInputChange = (index, field, value) => {
    const updatedLabels = [...sccompressionState.checkSheet.labels];
  ...
  const handleAddRow = () => {
    ...
    dispatch(
      setscCompressionRecord({
        ...
        checkSheet: {
          ...sccompressionState.checkSheet,
          labels: [...sccompressionState.checkSheet.labels, newRow],
        },
      })
    );
  };
  ...
  const handleRemoveRow = (index) => {
    const updatedLabels = sccompressionState.checkSheet.labels.filter(
      (_, i) => i !== index
    );
    dispatch(
      setscCompressionRecord({
  ...
  return (
    <Card className="max-w-7xl mx-auto">
      <CardContent>
        ...
        Weight Record Sheet (In process)
        </h2>
            ...
            <tbody>
              <tr>
                ...
                <td colSpan="1">
                  <TextField
                    label="Upper Limit"
                    value={sccompressionState.checkSheet.upperLimit}
                    onChange={(e) =>
                ...
                <td colSpan="2">
                  <TextField
                    label="Target weight"
                    value={sccompressionState.checkSheet.targetWeight}
                    onChange={(e) =>
                ...
                <td colSpan="2">
                  <TextField
                    label="Lower Limit"
                    value={sccompressionState.checkSheet.lowerLimit}
                    onChange={(e) =>
              ...
              <tr>
                ...
                <td colSpan="1">
                  <TextField
                    label="Date started"
                    type="date"
                    value={sccompressionState.checkSheet.dateStarted}
                    onChange={(e) =>
                ...
                <td colSpan="1">
                  <TextField
                    ...
                    type="date"
                    value={sccompressionState.checkSheet.dateCompleted}
                    onChange={(e) =>
        ...
        <TableContainer component={Paper}>
          <Table size="small">
            ...
            <TableBody>
              {sccompressionState.checkSheet.labels.map((row, index) => (
                <TableRow key={index}>
        ...
        <div className="mt-4">
          ...
          <TextField
            ...
            rows={4}
            fullWidth
            value={sccompressionState.checkSheet.remarks}
            onChange={(e) =>
