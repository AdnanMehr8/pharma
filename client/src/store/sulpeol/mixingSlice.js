...
export const mixingSlice = createSlice({
  ...
  reducers: {
    setsMixingRecord: (state, action) => {
      ...
      localStorage.setItem("s-mixingRecord", JSON.stringify(state));
      console.log("Stored mixing record in local storage:", state);
    },
    resetsMixingRecord: (state) => {
      // Reset the state to initial values
      return initialState;
    },
    loadsMixingRecordFromStorage: (state) => {
      const mixingRecord = JSON.parse(localStorage.getItem("s-mixingRecord"));
