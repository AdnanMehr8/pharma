...
export const compressionSlice = createSlice({
  ...
  initialState,
  reducers: {
    setsCompressionRecord: (state, action) => {
      console.log(
      ...
      localStorage.setItem("s-compressionRecord", JSON.stringify(state));
      console.log("Stored compression record in local storage:", state);
    },
    resetsCompressionRecord: (state) => {
      // Reset the state to initial values
      return initialState;
    },
    loadsCompressionRecordFromStorage: (state) => {
      const compressionRecord = JSON.parse(
        localStorage.getItem("s-compressionRecord")
      );
      console.log(
...
export const {
  ...
  resetsCompressionRecord,
  loadsCompressionRecordFromStorage,
